...
// //       // Show in-app alert if new notification arrived
...
// //         {page === 'mentees' && <MenteeDashboard onSelectMentee={(mentee) => setPage('mentee-detail')} />}
// //         {page === 'mentees' && <MenteeDashboard onSelectMentee={menteeId => setPage(`mentee-${menteeId}`)} />}
// //       </main>
