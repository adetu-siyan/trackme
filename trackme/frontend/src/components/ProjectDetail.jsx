...
//     if (!window.confirm(
//       'Mark this project as completed? It will be removed from your active list.'
//     )) return
//     setEnding(true)
//     setEndError(null)
//     try {
...
//                 border: '1px solid var(--border)',
//               }}>
//                 {p.role === 'creator' ? <Crown size={11} /> : <User size={11} />}
...
//                   Due <strong style={{
//                     color: deadline.overdue ? 'var(--danger)' : 'var(--text-primary)',
//                   }}>
//                     {deadline.formatted}
//                   </strong>
...
//                 }}
//                 onMouseEnter={e => {
//                   if (!ending) e.currentTarget.style.background = 'var(--danger-soft)'
//                 }}
//                 onMouseLeave={e => {
...
//               </button>
//               {endError && (
//                 <span style={{ fontSize: 11, color: 'var(--danger)' }}>{endError}</span>
//               )}
//             </div>
//           )}
//         </div>
...
//                         {deadline.overdue
//                           ? `${Math.abs(deadline.daysLeft)} days past deadline`
...
//                 border: '1px solid var(--border)',
//                 display: 'flex', alignItems: 'center', gap: 14,
//                 marginBottom: p.submission_notes ? 0 : 0,
//               }}>
//                 <div style={{
//                   width: 40, height: 40, borderRadius: 10, flexShrink: 0,
...
//                 <div>
//                   <div style={{
//                     fontSize: 16, fontWeight: 700, color: 'var(--accent)', marginBottom: 2,
//                   }}>
...
//                     }}>
//                       Based on {completion.log_count} log
//                       {completion.log_count !== 1 ? 's' : ''} tagged to this project
//                     </div>
//                   </div>
...
//                             borderBottom: i < completion.covered_areas.length - 1
...
//                             fontSize: 13, color: 'var(--text-secondary)',
//                             padding: '4px 0', lineHeight: 1.5,
//                             borderBottom: i < completion.missing_areas.length - 1
